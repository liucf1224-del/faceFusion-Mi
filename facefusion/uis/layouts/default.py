...
def pre_check() -> bool:
	print("DEBUG: Running default layout pre_check")
	return True


def render() -> gradio.Blocks:
	print("DEBUG: Rendering default layout")
	...
	print("DEBUG: Finished rendering default layout")
	return layout


def listen() -> None:
	print("DEBUG: Setting up listeners for default layout")
	processors.listen()
	...
	print("DEBUG: Finished setting up listeners for default layout")


def run(ui : gradio.Blocks) -> None:
	print("DEBUG: Running default UI layout...")
	print(f"DEBUG: open_browser setting = {state_manager.get_item('open_browser')}")
	ui.launch(favicon_path = 'facefusion.ico', inbrowser = state_manager.get_item('open_browser'))
	print("DEBUG: UI launch command executed")