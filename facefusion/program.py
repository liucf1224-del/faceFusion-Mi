...
def create_log_level_program() -> ArgumentParser:
	...
	group_misc.add_argument('--skip-nsfw-check', help = translator.get('help.skip_nsfw_check'), action = 'store_true', default = config.get_bool_value('misc', 'skip_nsfw_check'))
	job_store.register_job_keys([ 'log_level', 'skip_nsfw_check' ])
	return program
